    ...
    fn partial_cmp(&self, other: &RollOptions) -> Option<Ordering> {
        match self {
            ...
            RollOptions::ExplodeOn(_) => match other {
                ...
                RollOptions::Nothing | RollOptions::RerollOn(_) => Some(Ordering::Greater),
                _ => Some(Ordering::Less),
            },
            RollOptions::DropLowest(_) => match other {
                RollOptions::DropLowest(_) | RollOptions::KeepBest(_) => Some(Ordering::Equal),
    ...
    fn cmp(&self, other: &RollOptions) -> Ordering {
        match self {
            ...
            RollOptions::ExplodeOn(_) => match other {
                ...
                RollOptions::Nothing | RollOptions::RerollOn(_) => Ordering::Greater,
                _ => Ordering::Less,
            },
            RollOptions::DropLowest(_) => match other {
                RollOptions::DropLowest(_) | RollOptions::KeepBest(_) => Ordering::Equal,
